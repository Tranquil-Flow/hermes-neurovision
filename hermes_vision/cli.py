...
def main(argv=None):
    ...
    # Handle import
    if args.import_file:
        from hermes_vision.import_theme import import_theme, IncompatibleVersionError
        try:
            ...
            if result.get("preview"):
                ...
                print(f"\nTest it with: hermes-vision --theme {result['name']}\n")
    ...
    # Handle list
    if args.list_themes:
        from hermes_vision.import_theme import list_themes
