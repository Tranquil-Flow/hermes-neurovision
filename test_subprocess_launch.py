...
print("Testing subprocess launch of hermes-vision auto_launch...")
print()
...
print("\n[3] Check if hermes-vision is running:")
ps_result = subprocess.run(
    ["ps", "aux"],
    capture_output=True,
    text=True
)
count = sum(1 for line in ps_result.stdout.split('\n') if 'hermes-vision' in line and 'grep' not in line)
print(f"  Found {count} hermes-vision processes")
